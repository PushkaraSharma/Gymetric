...
const Memberships = () => {
    ...
    const MembershipCards = ({ item }: { item: any }) => (
        <Pressable style={[$styles.card, $styles.flexRow, { padding: spacing.sm, marginVertical: spacing.xs, opacity: item.active ? 1 : 0.5 }]} disabled={!item.active} onPress={() => navigate('Create Edit Membership', { item })}>
