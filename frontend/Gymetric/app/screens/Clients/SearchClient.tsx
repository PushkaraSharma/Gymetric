...
const SearchClient = ({ route }: any) => {
    ...
    return (
        ...
        >
            <Header title={`Add Dependent ${route?.params?.index + 1}`} backgroundColor={colors.surface} leftAction={<Pressable style={[$styles.row, { paddingHorizontal: 10 }]} onPress={goBack}>
