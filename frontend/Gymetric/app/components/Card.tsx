...
const $containerBase: ThemedStyle<ViewStyle> = (theme) => ({
  ...
  borderWidth: 1,
  shadowColor: theme.colors.palette.slate900,
...
const $containerPresets: Record<Presets, ThemedStyleArray<ViewStyle>> = {
  ...
  reversed: [
    ...
    $containerBase,
    (theme) => ({
      backgroundColor: theme.colors.palette.slate800,
      borderColor: theme.colors.palette.slate600,
    }),
  ],
}
...
const $headingPresets: Record<Presets, ThemedStyleArray<TextStyle>> = {
  default: [],
  reversed: [(theme) => ({ color: theme.colors.palette.slate50 })],
}
