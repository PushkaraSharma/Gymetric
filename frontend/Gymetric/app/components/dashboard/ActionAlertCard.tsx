...
const $title: ThemedStyle<TextStyle> = ({ typography, colors, spacing }) => ({ fontFamily: typography.secondary.bold, fontSize: 28, color: colors.text, marginBottom: spacing.xs })
...
const $buttonText: ThemedStyle<TextStyle> = ({ colors, typography }) => ({ color: colors.background, fontFamily: typography.primary.semiBold, fontSize: 14 })
...
const $secondaryButtonText: ThemedStyle<TextStyle> = ({ colors, typography }) => ({ color: colors.text, fontFamily: typography.primary.medium, fontSize: 13 })
